     ...
     <div 
        ...
        >
            <ul 
                ...
                "
            >
                <li class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer transition-all duration-300">
                    Sell on AliExpress
                </li>
                <li class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer transition-all duration-300">
                    Cookie Preferences
                ...
                <li class="px-3 hover:text-[#FF4646] cursor-pointer transition-all duration-300">
                ...
                <li 
                    ...
                    class="relative flex items-center px-2.5 hover:text-[#FF4646] h-full cursor-pointer transition-all duration-300"
